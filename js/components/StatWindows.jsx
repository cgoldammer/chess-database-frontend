      ...
      <div>
        <div className={styles.statHeader}>
          ...
          <div className={styles.statContent}>
            <p>As with all statistics, one should not over-interpret the result. 
            For instance, if a player makes more mistakes than another player, that 
            does not necessarily imply that the player plays less well, 
            it could also be because the player has a sharper style.</p>
            <p>The table provides the average centi-pawn (CP) loss per player. 
            For instance, if a player blunders a pawn on every second move, 
            but otherwise plays perfect moves, that player would have a CP 
            Loss of 50.</p>
          </div>
          { table }
        </div>
