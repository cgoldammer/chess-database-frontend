...
class SolutionShow extends React.Component {
	...
	render () {
		return (
			<div class={"show-solution"} onClick={this.props.onClick}>{this.props.showSolution ? "Solution is: " + myData[this.props.selectedIndex].best : "Show solution"}</div>
		)
	}
}
