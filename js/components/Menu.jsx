...
import {objectIsEmpty, loginConsts, loginData, loginOrRegisterUser, 
  logout, getUser, showFeedback, getUrl,} from '../helpers.jsx';
        ...
        <Modal.Body>
          <div>
            <p className={styles.description}>
              This is a chess database that stores games and helps you obtain 
              useful data on those games.
            </p>
            <p className={styles.description}>
              For each game, the database stores the computer evaluation of all 
              moves. Right now, the tool shows simple statistics.
            </p>
            <p className={styles.description}>
              The goal is to expand the tool so that you can upload your own 
              databases, and use this database to find out how to improve or 
            ...
            <p className={styles.description}> 
              <a href='mailto:goldammer.christian@gmail.com?Subject=Chess%20insights' 
                target='_top'>Send me an email!</a> </p>
          </div>
        </Modal.Body>
        <Modal.Footer>
...
export class Login extends Component {
  ...
  handleSubmit = event => {
    ...
    loginOrRegisterUser(this.props.loginType, this.state.email, this.state.password, 
      this.props.putLoginOrRegister);
  }
  ...
  render() {
    ...
    const resetButton = !this.props.loginError ?  null : 
      <Button block 
        bsSize='large' 
        onClick={this.setToResetPassword}>Forgot password?</Button>;
    var modalBody = (
      <div>
        <form onSubmit={this.handleSubmit}>
          ...
          { this.props.loginError ? <HelpBlock 
            bsStyle='warning' style={{color: 'red',}}> 
